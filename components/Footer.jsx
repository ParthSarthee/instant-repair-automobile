...
function Footer() {
	return (
		<div className="mt-24 bg-neutral-900 text-white p-8 text-center justify-center flex flex-col gap-8">
			<div className="flex sm:flex-row justify-evenly items-center flex-col">
				<button className="mt-4 bg-primary text-white px-4 py-2 w-[200px] font-semibold rounded">
					About Us
				</button>
				<button className="mt-4 bg-primary text-white px-4 py-2 w-[200px] font-semibold rounded">
					Contact Us
